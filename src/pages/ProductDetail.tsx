...
const ProductDetail = () => {
  ...
  return (
    <Layout>
      {/* 1. HERO / HEADER PRODUIT - Bordure réduite à 3px */}
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="max-w-4xl border-l-[3px] border-accent pl-8 md:pl-12">
            <div className="flex items-center gap-3 mb-6">
              <span className="bg-accent text-slate-900 font-black px-3 py-0.5 uppercase text-[10px] tracking-wider border-[1.5px] border-slate-900">
            ...
            <h1 className="text-5xl md:text-8xl font-black mb-4 uppercase tracking-tighter italic leading-[0.9]">
      ...
      {/* 2. NAVIGATION BREADCRUMB - Bordure réduite à 1.5px */}
      <nav className="bg-white border-b-[1.5px] border-slate-200 py-4 overflow-x-auto">
        <div className="container mx-auto px-4 flex items-center gap-4 text-[10px] font-black uppercase tracking-widest whitespace-nowrap">
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-12 gap-12">
            ...
            {/* Colonne Image (5/12) - Ombre réduite à 4px */}
            <div className="lg:col-span-5">
              <div className="sticky top-32">
                <div className="bg-white border-[1.5px] border-slate-900 p-1.5 shadow-[4px_4px_0px_0px_rgba(251,146,60,1)]">
                  {product.img ? (
                    <img 
                      src={product.img} 
                  ...
                  <div className="bg-slate-900 text-white p-4 mt-1.5 flex justify-between items-center">
                    <span className="font-black uppercase tracking-widest text-[10px]">Aperçu technique</span>
            ...
            <div className="lg:col-span-7 space-y-10">
              {/* SPECIFICATIONS BOX - Bordure 3px */}
              ...
              {/* CTA AREA - Boutons affinés */}
              <div className="grid sm:grid-cols-2 gap-4 pt-8">
                <Link to="/quote">
                  <Button className="w-full h-16 rounded-none bg-accent hover:bg-slate-900 text-slate-900 hover:text-white font-black uppercase tracking-widest text-base transition-all border-b-[3px] border-slate-900">
                    DEMANDER UN DEVIS
                ...
                {product.pdf && (
                  <a href={product.pdf} target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" className="w-full h-16 rounded-none border-[1.5px] border-slate-900 bg-white hover:bg-slate-50 font-black uppercase tracking-widest text-base transition-all">
              ...
              <div className="bg-slate-900 text-white p-6 flex items-start gap-6 border-t-[3px] border-accent">
                ...
                <div>
                  <h4 className="font-black uppercase text-[10px] tracking-widest mb-1 text-accent">Qualité SICAF Certifiée</h4>
          ...
          {/* FOOTER NAVIGATION - Bordure 1.5px */}
          <div className="flex flex-col sm:flex-row justify-between items-center mt-24 py-8 border-t-[1.5px] border-slate-200 gap-6">
            <Link to={`/products/${categoryId}`}>
              <Button variant="ghost" className="rounded-none font-black uppercase tracking-widest text-[10px] gap-3 hover:text-accent">
                <ArrowLeft className="h-4 w-4" />
                RETOUR À {category.name[language]}
              </Button>
            </Link>
            <Link to="/catalog">
              <span className="text-slate-200 font-black italic text-3xl hidden md:block tracking-tighter">SICAF SOLUTIONS</span>
            </Link>
            <Link to="/catalog">
              <Button variant="outline" className="rounded-none border-[1.5px] border-slate-900 font-black uppercase tracking-widest text-[10px] hover:bg-slate-900 hover:text-white transition-all">

...
import watermarkImage from '@/assets/watermark.png'; // image semi-transparente
    ...
    <Layout>
      ...
      <div className="absolute inset-0 z-0 pointer-events-none flex justify-center items-center">
        ...
        <svg
          ...
          className="absolute opacity-5 rotate-[-25deg]"
        >
          <text
            x="50%"
            y="50%"

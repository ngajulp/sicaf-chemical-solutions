...
const Index = () => {
  ...
  return (
    <Layout>
      ...
      <section className="relative bg-[#001529] text-white min-h-[85vh] flex items-center overflow-hidden border-b-4 border-[#DAA520]">
  ...
  <div className="absolute inset-0 z-0">
    ...
    />
    {/* Overlay pour la lisibilité et la teinte bleue SICAF */}
    <div className="absolute inset-0 bg-[#001529]/80 mix-blend-multiply" />
  </div>
  ...
  <div className="container mx-auto px-6 relative z-10">
    <div className="max-w-4xl">
      <div className="flex items-center gap-4 mb-8">
        ...
        <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#DAA520]">
          Expertise Industrielle
        </span>
      </div>

      <h1 className="text-6xl md:text-8xl font-black uppercase italic leading-[0.85] tracking-tighter mb-10">
      ...
      <p className="text-base md:text-xl text-blue-100/80 max-w-2xl mb-12 font-medium leading-tight border-l-4 border-[#DAA520] pl-6 italic">
        {t('hero.subtitle')}
      </p>
  ...
  {/* Vos vagues décoratives (Placées au dessus du filigrane, en bas) */}
  <div className="absolute bottom-0 left-0 right-0 overflow-hidden z-20 pointer-events-none">
    <svg className="relative w-full h-12 md:h-20" viewBox="0 0 1200 120" preserveAspectRatio="none">
      <path d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z" 
            opacity=".1" className="fill-white" />

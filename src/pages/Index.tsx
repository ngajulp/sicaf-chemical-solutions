...
const WatermarkOverlay: React.FC<WatermarkProps> = ({ opacity = 0.1, size = 150, rotation = 0 }) => (
  <div
  ...
  return (
    <Layout>
      ...
      <section className="relative gradient-hero text-primary-foreground py-20 md:py-32">
        <WatermarkOverlay opacity={0.12} size={180} rotation={-15} />
      ...
      <section className="py-16 md:py-24 bg-background relative">
        <WatermarkOverlay opacity={0.08} size={140} rotation={10} />
      ...
      <section className="py-16 md:py-24 bg-muted relative">
        <WatermarkOverlay opacity={0.1} size={160} rotation={-5} />
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4">
              {t('home.why_title')}

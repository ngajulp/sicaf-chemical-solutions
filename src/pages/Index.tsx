...
const WATERMARK_URL = 'https://raw.githubusercontent.com/ngajulp/sicaf-chemical-solutions/main/public/sicaf.png';
...
const Watermark = ({ size = 500, opacity = 0.12, rotation = -20 }: WatermarkProps) => (
  <div
  ...
  >
    <svg className="absolute w-full h-full">
      <defs>
        <pattern id="chemPatternUltra" width="200" height="200" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
          <circle cx="50" cy="50" r="20" fill="rgba(255,255,255,0.05)" />
          <circle cx="150" cy="150" r="20" fill="rgba(255,255,255,0.05)" />
          <circle cx="100" cy="100" r="10" fill="rgba(255,255,255,0.08)" />
          <line x1="0" y1="0" x2="200" y2="200" stroke="rgba(255,255,255,0.03)" strokeWidth="2"/>
          <line x1="200" y1="0" x2="0" y2="200" stroke="rgba(255,255,255,0.03)" strokeWidth="2"/>
        </pattern>
      </defs>
      <rect width="100%" height="100%" fill="url(#chemPatternUltra)" />
    </svg>
  </div>
);
  ...
  return (
    <Layout>
      ...
      <section className="gradient-hero text-primary-foreground py-20 md:py-32 relative overflow-hidden">
        <Watermark size={600} opacity={0.15} rotation={-25} />
      ...
      <section className="py-16 md:py-24 bg-background relative">
        <Watermark size={450} opacity={0.1} rotation={-15} />
        <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {categories.map((category) => (
                <Link key={category.id} to={`/products/${category.id}`}>
                  <Card className="group h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-2 border-transparent hover:border-primary/20 relative z-10">
      ...
      <section className="py-16 md:py-24 bg-muted relative">
        <Watermark size={400} opacity={0.08} rotation={-10} />
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4">
              {t('home.why_title')}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <Card key={index} className="text-center border-none shadow-md relative z-10">
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-20 gradient-primary text-primary-foreground relative">
        <Watermark size={550} opacity={0.12} rotation={-20} />

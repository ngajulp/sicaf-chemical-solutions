  ...
  return (
    <Layout>
      ...
      <section className="py-16 md:py-24 bg-background relative overflow-hidden">
        {/* FILIGRANE MODIFIÉ : Occupe tout l'arrière-plan */}
        <div 
          className="absolute inset-0 z-0 opacity-25 pointer-events-none grayscale"
          style={{
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4 drop-shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {categories.map((category) => (
                <Link key={category.id} to={`/products/${category.id}`}>
                  {/* bg-white/90 pour assurer la lisibilité sur le filigrane sombre */}
                  <Card className="group h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-2 border-transparent hover:border-primary/20 bg-white/90 backdrop-blur-md">
      ...
      <section className="py-16 md:py-24 bg-muted relative overflow-hidden">
        {/* NOUVEAU FILIGRANE : Pourquoi Choisir SICAF */}
        <div 

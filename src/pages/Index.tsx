...
const Index = () => {
  ...
  // Style du watermark pour toutes les sections
  ...
  return (
    <Layout>
      ...
      {/* Hero Section */}
      <section className="gradient-hero text-primary-foreground py-20 md:py-32 relative" style={watermarkStyle}>
      ...
      {/* Product Categories */}
      <section className="py-16 md:py-24 relative" style={watermarkStyle}>
        <div className="container mx-auto px-4 relative z-10">
      ...
      {/* Why Choose Us */}
      <section className="py-16 md:py-24 bg-muted relative" style={watermarkStyle}>
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4">
              {t('home.why_title')}
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-20 gradient-primary text-primary-foreground relative" style={watermarkStyle}>

...
const Index = () => {
  ...
  // URL du watermark en raw depuis GitHub
  const watermarkUrl = 'https://raw.githubusercontent.com/ngajulp/sicaf-chemical-solutions/main/public/sicaf.png';

  // Style du watermark : rotation et opacité réduite
  const watermarkStyle = {
    position: 'relative' as const,
    zIndex: 0,
    overflow: 'hidden',
    // pseudo-background watermark avec rotation
    backgroundImage: `url(${watermarkUrl})`,
    backgroundRepeat: 'repeat',
    backgroundSize: '400px auto', // légèrement plus petit pour meilleure répétition
    opacity: 0.3,
    transform: 'rotate(-25deg)', // rotation pour un effet moins carré
  };

  // Wrapper pour appliquer le watermark tout en gardant le contenu lisible
  const sectionWrapper = (children: React.ReactNode) => (
    <div className="relative" style={watermarkStyle}>
  ...
  return (
    <Layout>
      ...
      {/* CTA Section */}
      {sectionWrapper(
        <section className="py-16 md:py-20 gradient-primary text-primary-foreground text-center">
